                        ...
                        function m(e) {
                            ...
                            for (var t, i, n, a = /^\s*at (.*?) ?\(((?:file|https?|blob|chrome-extension|native|eval|webpack|<anonymous>|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i, s = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)((?:file|https?|blob|chrome|webpack|resource|\[native).*?|[^@]*bundle)(?::(\d+))?(?::(\d+))?\s*$/i, d = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:file|ms-appx|https?|webpack|blob):.*?):(\d+)(?::(\d+))?\)?\s*$/i, A = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, u = /\((\S*)(?::(\d+))(?::(\d+))\)/, h = e.stack.split("\n"), m = [], g = /^(.*) is undefined$/.exec(e.message), f = 0, v = h.length; f < v; ++f) {
                                if (i = a.exec(h[f])) {
                                    ...
                                    i[4] = t[2],
                                    i[5] = null) : 0 !== f || i[5] || p(e.columnNumber) || (m[0].column = e.columnNumber + 1),
                                    n = {
                                        url: i[3],
                                        func: i[1] || c,
                                        args: i[2] ? i[2].split(",") : [],
                        ...
                        function v(t, a) {
                            ...
                            try {
                                if (s = function(e) {
                                    ...
                                    if (t.length < 4)
                                        return null;
                                    var a, s = /^\s*Line (\d+) of linked script ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, c = /^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?|blob)\S+)(?:: in function (\S+))?\s*$/i, l = /^\s*Line (\d+) of function script\s*$/i, p = [], h = i && i.document && i.document.getElementsByTagName("script"), m = [];
                                    for (var g in h)
    ...
    (()=>{
        ...
        const b = function() {
            ...
            e.trackSavegames = function() {
                window.cookieStore && window.cookieStore.getAll && We.gameId && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (v || (v = Math.random().toString(36).substr(2, 9),
                p(f, v)),
                e.collectAndLog(),
        ...
        var K = "rewarded"
          ...
          , F = !1
          , X = function(e, t, i) {
            if (Ye.prebidAvailable) {
                F = !0;
                var n = ["US", "CA", "AU"]
                  , r = function(e) {
                    var i, r = S() || y() || w() ? ["video/mp4", "application/javascript"] : ["video/mp4", "video/webm", "video/ogg", "application/javascript"], o = G(G({
                        mimes: r,
                        minduration: 0,
                        maxduration: 15,
                  ...
                  , s = [{
                    ...
                    bids: U(U([{
                        ...
                        bidder: "sharethrough",
                        params: {
                            pkey: M.leaderboard[Z] || M.leaderboard[3]
                        }
                    }, {
                        bidder: "triplelift",
                        params: {
                    ...
                    bids: U(U([{
                        ...
                        bidder: "sharethrough",
                        params: {
                            pkey: M.skyscraper[Z] || M.skyscraper[3]
                        }
                    }, {
                        bidder: "triplelift",
                        params: {
                    ...
                    bids: U(U([{
                        ...
                        bidder: "sharethrough",
                        params: {
                            pkey: M.rectangle[Z] || M.rectangle[3]
                        }
                    }, {
                        bidder: "triplelift",
                        params: {
                    ...
                    bids: U(U([{
                        ...
                        bidder: "sharethrough",
                        params: {
                            pkey: M.billboard[Z] || M.billboard[3]
                        }
                    }, {
                        bidder: "triplelift",
                        params: {
                    ...
                    bids: U(U([{
                        ...
                        bidder: "sharethrough",
                        params: {
                            pkey: M.mobile_leaderboard[Z] || M.mobile_leaderboard[3]
                        }
                    }, {
                        bidder: "triplelift",
                        params: {
        ...
        function Y(e, t, i, r, o, s, d) {
            ...
            if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
                var c, l = k().split("?"), u = encodeURIComponent(l[0]), p = r ? K : Q, h = a.getDataAnnotations(), m = 0, g = function() {
                    var r, l, g;
                    if (!(--m > 0))
                        try {
                            ...
                            if (s) {
                                ...
                                if (1 !== d && (!k || !k.videoCacheKey || k.cpm < P(o))) {
                                    var S = 5;
                                    ...
                                    k = {
                                        cpm: S,
                                        vast: "https://api.poki.com/ads/houseads/video/vast" + ("" === We.gameId ? "" : "?game_id=" + We.gameId),
                                        bidder: "poki",
                                        videoCacheKey: "poki"
                                    }
                                }
        ...
        function $() {
            ...
            return "yes" === I("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"),
            !0) : "localhost" !== t && "game-cdn.poki.com" !== t && !t.endsWith(".poki-gdn.com") && ("ninja.io" === t ? Math.random() <= .5 : "venge.io" === t ? Math.random() <= .05 : "makeitmeme.com" === t)
        }
        var ee = function() {
            function e(e, t) {
                void 0 === t && (t = {}),
            ...
            e.prototype.buildAdUnitPaths = function(e) {
                ...
                var a = "/21682198607/";
                return Ye.GetIsPokiIFrame() ? ["" + a + i + "_ingame_" + o + "_1/" + this.siteID + "_" + i + "_ingame_" + o + "_1", "" + a + i + "_ingame_" + o + "_2/" + this.siteID + "_" + i + "_ingame_" + o + "_2"] : [a + "external_" + i + "_video_1/external_" + i + "_ingame_" + o + "_1", a + "external_" + i + "_video_2/external_" + i + "_ingame_" + o + "_2"]
            }
            ,
            ...
            e.prototype.requestAd = function() {
                ...
                Ye.consentString && Ye.consentString.length > 0 && (this.criteria.consent_string = Ye.consentString);
                ...
                Ye.childDirected && (d += "&tfcd=1"),
                Ye.nonPersonalized && (d += "&npa=1"),
                a.setDataAnnotations({
                    adUnitPath: t,
                    adTagUrl: d,
                ...
                Y(this.ima, d, this.criteria, this.rewarded, this.country, !0, this.retries)) : 1 === this.retries ? (console.debug("adRequest started with Prebid Video enabled (" + this.retries + "/" + this.totalRetries + ")"),
                Y(this.ima, d, this.criteria, this.rewarded, this.country, !1, this.retries)) : (console.debug("adRequest started in plain mode (" + this.retries + "/" + this.totalRetries + ")"),
        ...
        function ye() {
            if (document.body && document.body.appendChild) {
                ...
                !window.location.hostname.endsWith("poki-gdn.com") && We.gameId)) {
                    var t = document.createElement("iframe");
                    t.style.display = "none",
                    t.src = "https://" + We.gameId + ".poki-gdn.com/poki-savegame-store.html",
                    t.onload = function() {
        ...
        const xe = function() {
            ...
            e.prototype.onAdsManagerLoaded = function(e) {
                ...
                t.mimeTypes = S() || y() || w() ? ["video/mp4"] : ["video/mp4", "video/webm", "video/ogg"],
          ...
          , Ue = function() {
            return Le(void 0, void 0, void 0, (function() {
                ...
                return Oe(this, (function(n) {
                    ...
                    case 3:
                        return (e = n.sent()) && ((t = document.createElement("script")).src = "//game-cdn.poki.com/scripts/touchOverlayController.js",
                        t.onload = function() {
        ...
        var qe = function() {
            ...
            return e.prototype.waitUntilReady = function(e) {
                window.googletag.cmd.push((function() {
                    Ye.prebidAvailable ? window.pbjs.que.push((function() {
                        e()
                    }
                    )) : e()
                }
                        ...
                        if (d && d.gptSlot) {
                            var A = t.slot || {}
                              ...
                              , b = function(e) {
                                ...
                                if (void 0 === window.pbjs || !Ye.prebidAvailable)
                                    return i;
                            ...
                            isNaN(y) && (y = void 0),
                            nt.track(n.tracking.ads.display.impression, {
                                size: d.size,
            ...
            e.prototype.getDisplaySlotConfig = function(e) {
                ...
                return r.debug || (i = Ye.GetIsPokiIFrame() ? "/21682198607/" + n + "_ingame_" + e + "/" + o + "_" + n + "_ingame_" + e : "/21682198607/external_" + n + "_display_ingame/external_" + n + "_ingame_" + e),
                {
                    id: "poki-" + Ze(),
                    adUnitPath: i,
                    size: e,
            ...
            e.prototype.requestAd = function(e) {
                var t;
                nt.track(n.tracking.ads.display.requested, {
                    size: e.size,
                ...
                var i = 0
                  , r = function() {
                    --i > 0 || (window.apstag && window.apstag.setDisplayBids(),
                    Ye.prebidAvailable && (window.pbjs.setTargetingForGPTAsync([e.adUnitPath]),
                    e.pbjsTargetting = window.pbjs.getAdserverTargetingForAdUnitCode([e.adUnitPath])),
                    window.googletag.display(e.id))
                };
                window.apstag && i++,
                Ye.prebidAvailable && i++,
                ...
                Ye.prebidAvailable && window.pbjs.requestBids({
                    adUnitCodes: [e.adUnitPath],
                    bidsBackHandler: function() {
                        r()
                    }
                }),
                window.apstag || Ye.prebidAvailable || r()
            }
            ,
            e.prototype.clearIGDAd = function(e) {
                ...
                if (i) {
                    ...
                    if (r) {
                        for (nt.track(n.tracking.screen.destroyAd, {
            ...
            t.prototype.allBidsBack = function(e) {
                ...
                if (a) {
                    ...
                    if (d) {
                        ...
                        isNaN(u) && (u = 0);
                        var p, h, m = (p = null === (i = null == a ? void 0 : a.amznTargetting) || void 0 === i ? void 0 : i.amznbid,
                        z[p] || 0);
                        m > u ? (h = null === (r = null == a ? void 0 : a.amznTargetting) || void 0 === r ? void 0 : r.amnzp,
                        l = R[h] || "Amazon",
                        u = m,
                        c = !1,
        ...
        var He = function() {
          ...
          , Je = function() {
            function e() {
                ...
                ,
                this.IGD = $() ? new Xe : new Ke;
                var e = I("pokiDebug");
                "" !== e && (this.setDebug("true" === e),
            ...
            e.prototype.lazyLoadInit = function() {
                ...
                this.debugTouchOverlayController && (y() || w()) && Ue();
                var T = [k(), S()]
                  , _ = Ve(Ve([], T, !0), [Me()], !1);
                this.isBot || (_.push(Ce("https://imasdk.googleapis.com/js/sdkloader/ima3.js"), Ce("https://securepubads.g.doubleclick.net/tag/js/gpt.js")),
                (I("url_referrer") || "").includes("kiloo.com") ? (e.prebidAvailable = !1,
                e.childDirected = !0,
                e.nonPersonalized = !0,
                this.IGD.enforceChildSafety()) : _.push(Ce("https://a.poki.com/prebid/prebid6.12.0.js"), Ce("https://c.amazon-adsystem.com/aax2/apstag.js")));
                var B = function(e, i, o) {
                    if (void 0 === o && (o = !0),
                    t.country = (x || (null == i ? void 0 : i.ISO) || "ZZ").toUpperCase(),
                    t.isCCPA = void 0 === C ? (null == i ? void 0 : i.ccpaApplies) || !1 : C,
                    e) {
                        We.gameId || (We.gameId = e.gameId);
                        ["7fb1fd45-24ce-4ade-b5c4-9ee55ec99526"].includes(We.gameId) && (y() || w()) && Ue(),
                        v.adTiming = e.adTiming,
                        v.customCriteria = He(He({}, v.customCriteria), {
                            p4d_game_id: We.gameId
                        })
                    }
                    Ie(t.country) && !r.debug && (W(),
                ...
                return Promise.all(_).catch((function() {
                    ...
                    if (void 0 !== e) {
                        ...
                        t.isInitialized = !0,
                        t.isCCPA || l ? r.debug && a.dispatchEvent(n.ready) : a.dispatchEvent(n.ready)
                    }
                }
                ))
            }
                                ...
                                if (!this.isCCPA || this.installedUSP)
                                    if (this.ima.isAdRunning() || this.waterfall.isRunning())
                                        ...
                                        if (u === n.ads.position.rewarded || this.adTimings.requestPossible())
                                            if (u !== n.ads.position.rewarded && this.adSettings.countryExclusion.includes(this.country))
                                                a.dispatchEvent(n.ads.limit, {
                                                    reason: n.info.messages.disabled
                                                });
                                            else {
                                                var p = He(He(He({}, this.genericCriteria()), this.criteria), {
                                                    position: u
                                                });
                            ...
                            if (t) {
                                ...
                                if (e)
                                    if (this.sdkImaError)
                                        ...
                                        var d = He(He({}, this.genericCriteria()), this.criteria);
            ...
            e.prototype.enableSettings = function(e) {
                this.criteria = He({}, e.customCriteria),
                this.adTimings = new c(e.adTiming)
            }
            ,
            e.prototype.setDebug = function(e) {
                this.debugIsOverwritten ? e && nt.track(n.tracking.debugTrueInProduction) : r.debug = e
            }
            ,
        ...
        const $e = function() {
            ...
            return e.sendMessage = function(e, t) {
                ...
                var o = t || {};
                We.gameId && We.versionId && (o.pokifordevs = {
                    game_id: We.gameId,
                    game_version_id: We.versionId
                }),
                i.postMessage({
                    type: e,
                    content: o
        ...
        var et = function(e) {
            ...
            return Object.keys(e).forEach((function(i) {
                "object" == typeof e[i] ? t = t.concat(et(e[i])) : t.push(e[i])
            }
            )),
            t
        };
        ...
        const nt = function() {
            ...
            return e.track = function(e, t) {
                if (void 0 === t && (t = {}),
                -1 === it.indexOf(e))
                    throw new TypeError("Invalid 'event', must be one of " + it.join(", "));
                if ("object" != typeof t)
        ...
        var ot = "poki_erruid"
          ...
          , st = u(ot);
        function dt() {
            return st || (st = Math.random().toString(36).substr(2, 9),
            p(ot, st)),
            st
        }
        function At(e) {
        ...
        window.onunhandledrejection = function(e) {
            rt(e.reason) ? t().report(e.reason) : At({
            ...
            function t() {
                ...
                this.init = function(e) {
                    ...
                    new Promise((function(i, r) {
                        ...
                        $e.sendMessage(n.message.sdkDetails, {
                            version: "2.264.0"
                        })
                    }
                    ))
                ...
                this.gameLoadingProgress = function(e) {
                    ...
                    nt.track(n.tracking.screen.gameLoadingProgress, t)
                }
                ,
                this.gameLoadingStart = function() {
                    var e, t;
                    nt.track(n.tracking.screen.gameLoadingStarted, {
                ...
                this.gameLoadingFinished = function() {
                    ...
                    nt.track(n.tracking.screen.gameLoadingFinished, {
                        transferSize: i,
                        trackers: (r = window,
                        o = [],
                ...
                this.gameplayStart = function(e) {
                    ...
                    nt.track(n.tracking.screen.firstRound),
                    t.SDK.startStartAdsAfterTimer()),
                    nt.track(n.tracking.screen.gameplayStart, ct(ct({}, e), {
                        playId: t.gameplayStartCounter
                    }))
                }
                ,
                this.gameInteractive = function() {
                    nt.track(n.tracking.screen.gameInteractive)
                }
                ,
                this.gameplayStop = function(e) {
                    t.gameplayStopCounter++,
                    t.duringGameplay = !1,
                    nt.track(n.tracking.screen.gameplayStop, ct(ct({}, e), {
                        playId: t.gameplayStartCounter,
                ...
                this.roundStart = function(e) {
                    void 0 === e && (e = ""),
                    e = String(e),
                    nt.track(n.tracking.screen.roundStart, {
                        identifier: e
                    })
                }
                ,
                this.roundEnd = function(e) {
                    void 0 === e && (e = ""),
                    e = String(e),
                    nt.track(n.tracking.screen.roundEnd, {
                        identifier: e
                    })
                }
                ,
                ...
                this.commercialBreak = function(e) {
                    return new Promise((function(i) {
                        ...
                        nt.track(n.tracking.screen.commercialBreak),
                        t.SDK.requestAd({
                            position: r,
                            onFinish: i,
                            onStart: e
                ...
                this.rewardedBreak = function(e) {
                    return new Promise((function(i) {
                        ...
                        nt.track(n.tracking.screen.rewardedBreak),
                        t.SDK.requestAd({
                            position: r,
                            onFinish: function(e) {
                ...
                this.happyTime = function(e) {
                    ...
                    nt.track(n.tracking.screen.happyTime, {
                        intensity: e
                    })
                }
                ,
                ...
                this.displayAd = function(e, i) {
                    a.clearAnnotations();
                    var r = Ze();
                    nt.track(n.tracking.screen.displayAd, {
                        size: i,
                        opportunityId: r,
                ...
                this.shareableURL = function(e) {
                    ...
                    new Promise((function(t, i) {
                        ...
                        if (Ye.GetIsPokiIFrame()) {
                            ...
                            t(a + "?" + r.toString()),
                            $e.sendMessage(n.message.setPokiURLParams, {
                                params: e
                            })
                        } else
                ...
                this.captureError = function(t) {
                    rt(t) ? e.report(t) : e.report(new Error(t))
                }
                ,
